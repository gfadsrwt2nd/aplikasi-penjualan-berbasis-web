	  ...
	  <div id="login-page" style="padding-top:3pc;">
	  	<div class="container">
		      <form class="form-login" method="POST">
		        <h2 class="form-login-heading">Aplikasi Penjualan Barang</h2>
		        <h3><font color="#64affa" font size="4"><center>CV. Sumber Bakti Mandiri<br>
		        	Developed by M.Rusdi 1913049
		        </center></font></h3>
